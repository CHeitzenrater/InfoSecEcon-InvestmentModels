...
#Cost of security (c), security level (s): The cost of security c is the amount 
# spent to reach a security level s. No security investment (c = 0) implies 
# s = 0, and for any c > 0, s increases monotonically in c.
#Effective security investment: If security investment is effective, the 
# security level can be approximated by the cost of security; i.e. s approx.=c.
##cost = 1;
##s = cost;
...
#------------------------------------------------------------------------------
#The RETURN ON ATTACK (ROA) ALE
#------
#------------------------------------------------------------------------------
ROI_ALE <- function( eff, CI, CS )
  ((eff * CI)/CS)-1;
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
#NET PRESENT VALUE (NPV): aggregates the expected net benefit of information 
# security over multiple future periods into a monetary equivalent at present
#------
...
# alpha, beta : alpha>0 and beta>1 capture security productivity (measures how the security investment reduced the probability of loss)
#------------------------------------------------------------------------------    
