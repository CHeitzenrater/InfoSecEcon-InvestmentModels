...
#lowBPFReduction <-  round( s_Reduction_alphaBeta(investmentRange, vConst, 1, 1), 3 )
#medBPFReduction <-  round( s_Reduction_alphaBeta(investmentRange, vConst, 1, 2), 3 )
#highBPFReduction <- round( s_Reduction_alphaBeta(investmentRange, vConst, 1, 3), 3 )
...
#####################################################################
#
# EXPERIMENTAL --- to play with parameters
#
## STEP 1
...
lowBPFReduction <-  round( s_Reduction_alphaBeta(investmentRange, vConst, 1/unitOfInvestment, 1, unitOfInvestment), 3 )
medBPFReduction <-  round( s_Reduction_alphaBeta(investmentRange, vConst, 1/unitOfInvestment, 2, unitOfInvestment), 3 )
highBPFReduction <- round( s_Reduction_alphaBeta(investmentRange, vConst, 1/unitOfInvestment, 3, unitOfInvestment), 3 )
