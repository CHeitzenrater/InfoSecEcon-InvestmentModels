...
S1S2 <- function(){
	...
	plot(investment, combined1, type="o", ylim=range(-11,2), lty=1, pch=15, ylab="ENBIS(z1+z2)", xlab="SSE Investment (z1)")
...
S1S2VaryAlpha2 <- function(){
	...
	plot(investment, combined1, type="o", ylim=range(-5,5), lty=1, pch=15, ylab="ENBIS(z1+z2)", xlab="SSE Investment (z1)")
	abline(0, 0, col = "black")
	lines(investment, combined2, type="o", lty=1, pch=0)
	lines(investment, combined3, type="o", lty=1, pch=16)
	lines(investment, combined5, type="o", lty=1, pch=17)
...
S1S2VaryAlpha <- function(){
	...
	plot(investment, combined1, type="o", ylim=range(-5,2), lty=1, pch=15, ylab="ENBIS(z1+z2)", xlab="SSE Investment (z1)")
	abline(0, 0, col = "black")
	lines(investment, combined2, type="o", lty=1, pch=0)
	lines(investment, combined3, type="o", lty=1, pch=16)
	lines(investment, combined5, type="o", lty=1, pch=17)
