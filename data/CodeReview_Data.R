#############################################################################
#
# Cost-effectiveness analysis of static analysis tools (SAT) and code review data
#
#############################################################################
...
# - people with security and SAT background successfully classify 67%; no one des much better


#############################################################################
# Paper SAT 1: Austin, A., Holmgreen, C. and Williams, L. "A comparison of the efficiency and effectiveness of vulnerability discovery techniques"  Information and Software Technology, Dec 2012
...
#############################################################################
# Paper SAT 2: Baca, D., Carlsson, B. and Lundberg, L.  "Evaluating the Cost Reduction of Static Code Analysis for Software Security", PLAS June 2008
#
# Notes:
#  - 2.6 more vuln by SAT (total of 59)
#  - lowered maintenance costs 18%
#  - effectiveness: E = b / (b+c), where b = TR found by SAT, c = TR not found by SAT
...
#############################################################################
# Paper SAT 4: Goseva-Popstojanova, K. and Perhinschi, A. "On the capability of static code analysis to detect security vulnerabilities", Journal of Information and Software Technology, Aug 2015
#
# Notes:
#  - 
#
...
#############################################################################
############################################################################# 
# Paper MAN 1: Kemerer, C.~F. and Paulk, M.~C. "The impact of design and code reviews on software quality: An empirical study" (self published??)
#
# Notes:
#  - 52-110 defects/KLOC
...
#############################################################################
# Paper MAN 2: Edumndson, A., Holtkamp, B., Rivera, E., Finifter, M., Mettler, A. and Wagner, D.  "An empirical study on the effectiveness of security code review" 
#
# Notes:
